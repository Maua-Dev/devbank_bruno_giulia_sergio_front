...
export default function DepositPage() {
  ...
  const handleCloseAlert = () => {
    ...
    setQuantidadeSacada(0);
  };

  const handleClick = async () => {
    console.log(transacao[200]);
    console.log(quantidadeSacada);
    const newQuantidadeSacada = 
      quantidadeSacada +
        transacao[10] * 10 +
        transacao[20] * 20 +
        transacao[2] * 2 +
    ...
    <main className="deposit_page">
      ...
      <div className="deposit_top_box">
        ...
        <p className="deposit_right_text">
          Quantidade sacada: R$ {quantidadeSacada}
        </p>
      </div>
      <div className="deposit_middle">
        ...
        <Cedula_Withdrawal valor={2}></Cedula_Withdrawal>
        <Cedula_Withdrawal valor={5}></Cedula_Withdrawal>
        <Cedula_Withdrawal valor={10}></Cedula_Withdrawal>
        <Cedula_Withdrawal valor={20}></Cedula_Withdrawal>
        <Cedula_Withdrawal valor={50}></Cedula_Withdrawal>
        <Cedula_Withdrawal valor={100}></Cedula_Withdrawal>
        <Cedula_Withdrawal valor={200}></Cedula_Withdrawal>
        <div>
          {alertVisibility && (
